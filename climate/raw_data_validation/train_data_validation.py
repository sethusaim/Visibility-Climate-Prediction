...
class Raw_Train_Data_Validation:
    ...
    def __init__(self, raw_data_bucket):
        ...
        self.train_schema_log = self.config["train_db_log"]["values_schema"]
    ...
    def values_schema(self):
        ...
        """
        method_name = self.values_schema.__name__
    ...
    def validate_raw_file_name(
        ...
        try:
            ...
            onlyfiles = self.s3.get_files_folder(
