...
class Raw_Data_validation:
    ...
    def __init__(self, path):
        ...
        self.train_schema_path = self.config["schema_dir"]["train_schema_file"]

        self.logger = App_Logger()

        self.db_name = self.config["db_log"]["db_train_log"]

        self.train_schema_log = self.config["train_db_log"]["values_from_schema_log"]

        self.train_gen_log = self.config["train_db_log"]["general_log"]

        self.train_name_valid_log = self.config["train_db_log"]["name_validation_log"]

        self.train_col_valid_log = self.config["train_db_log"]["col_validation_log"]

        self.train_missing_value_log = self.config["train_db_log"]["missing_values_log"]
    ...
    def valuesFromSchema(self):
        ...
        """
        try:
            with open(file=self.train_schema_path, mode="r") as f:
                dic = json.load(f)
