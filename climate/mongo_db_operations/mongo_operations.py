...
class MongoDB_Operation:
    ...
    def get_database(self, db_name, log_file):
        ...
        try:
            ...
            self.log_writer.log(
                log_file,
                f"Created {db_name} database in MongoDB",
            )
    ...
    def get_collection(self, database, collection_name, log_file):
        ...
        try:
            ...
            self.log_writer.log(
                log_file,
                f"Created {collection_name} collection in mongodb",
            )
    ...
    def get_collection_as_dataframe(self, db_name, collection_name, log_file):
        ...
        try:
            ...
            self.log_writer.log(
                log_file,
                "Converted collection to dataframe",
            )
    ...
    def insert_dataframe_as_record(
        ...
        try:
            ...
            self.log_writer.log(
                log_file,
                f"Converted dataframe to json records",
            )
