...
### Post Model Training
The solution application is exposed as API using FastAPI and application is dockerized using Docker. MLFlow setup is done in an AWS  Virtual Machine. CI-CD pipeline is created which will deploy the application to AWS  Container Instances, whenever new code is commmited to GitHub.
